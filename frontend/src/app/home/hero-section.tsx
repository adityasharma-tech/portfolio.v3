      ...
      <div className="w-full h-full">
        <div className="h-full flex flex-col justify-center gap-y-4">
          ...
          <h2 className="text-xl">
            I will try to do anything needed to launch a successfull <span className="font-medium underline underline-offset-2">product</span> in the market except writting code in Assembly.
          </h2>
          <div className="flex flex-row gap-x-4">
            <button onMouseDown={()=>setCliked(true)} onMouseUp={()=>setCliked(false)} className="relative px-8 group py-1.5 cursor-pointer my-5 text-neutral-900">
